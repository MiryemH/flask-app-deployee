...
class User(db.Model):
    ...
    # Clé étrangère qui relie chaque utilisateur à un rôle
    ...
    def __repr__(self):
        ...
        return f"<User login='{self.nom_user}'>"
...
class Role(db.Model):
    ...
    # Relation one-to-many : chaque rôle peut avoir plusieurs utilisateurs 
    # associés
    users = db.relationship('User', backref='role', lazy='dynamic')
    def __repr__(self):
        return f"<Role id={self.id}, name='{self.nom}'>"
